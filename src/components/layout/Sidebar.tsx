...
const roleMenuItems: Record<UserRole, { label: string; href: string; icon: React.ElementType }[]> = {
  ...
  hr: [
    ...
    { label: "Programs", href: "/dashboard/hr?tab=programs", icon: Building2 },
    { label: "New Hires", href: "/dashboard/hr?tab=new-hires", icon: GraduationCap },
    { label: "Reports", href: "/reports/hr-ld", icon: BarChart3 },
    { label: "Content", href: "/dashboard/hr?tab=content", icon: FileText },
    { label: "Settings", href: "/settings", icon: Settings },
  ],
  mentor: [
